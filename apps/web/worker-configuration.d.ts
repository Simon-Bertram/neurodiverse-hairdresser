/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 05d2ada8b6c96d1bab6e3a886b843ed5)
// Runtime types generated with workerd@1.20260219.0 2026-02-23 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		POLICY_AUD: string;
		TEAM_DOMAIN: string;
		EMAIL_SERVICE_ENV: string;
		RESEND_API_KEY: string;
		LUCY_BOOKING_EMAIL: string;
		DEV_BOOKING_EMAIL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_SERVER_URL" | "POLICY_AUD" | "TEAM_DOMAIN" | "EMAIL_SERVICE_ENV" | "RESEND_API_KEY" | "LUCY_BOOKING_EMAIL" | "DEV_BOOKING_EMAIL">> {}
}
